                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <div style={{ position: 'relative', width: '36px', height: '36px', flexShrink: 0 }}>
                        ...
                        <div style={{ position: 'absolute', bottom: '-4px', right: '-4px', width: '18px', height: '18px', borderRadius: '50%', backgroundColor: check.fg, border: `2px solid ${isDark ? '#1A1A1A' : '#FFFFFF'}` }} />
                      </div>
                      <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: '12px', fontFamily: 'JetBrains Mono, monospace', color: mutedText, flexShrink: 0 }}>{ratio.toFixed(2)}:1</span>
                      <span style={{ padding: '3px 9px', borderRadius: '20px', fontSize: '11px', fontWeight: '700', backgroundColor: meta.bg, color: meta.color, flexShrink: 0, minWidth: '68px', textAlign: 'center' as const }}>
                        {meta.icon} {level}
                      </span>
                    </div>
                  );
